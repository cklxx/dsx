...
fn filter_sensitive_write_roots(mut roots: Vec<PathBuf>, codex_home: &Path) -> Vec<PathBuf> {
    // Never grant capability write access to DSX_HOME or anything under DSX_HOME/.sandbox,
    // DSX_HOME/.sandbox-bin, or DSX_HOME/.sandbox-secrets. These locations contain sandbox
...
mod tests {
    ...
    fn payload_deny_write_paths_merge_explicit_and_protected_children() {
        ...
        let extra_codex = extra_write_root.join(".dsx");
