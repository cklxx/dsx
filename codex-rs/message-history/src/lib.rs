...
//!
//! The history is stored at `~/.dsx/history.jsonl` with **one JSON object per
...
/// Filename that stores the message history inside `~/.dsx`.
...
pub async fn append_entry(
    ...
    // Resolve `~/.dsx/history.jsonl` and ensure the parent directory exists.
