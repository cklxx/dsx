...
const GITHUB_LATEST_RELEASE_URL: &str = "https://api.github.com/repos/cklxx/dsx/releases/latest";
const HOMEBREW_CASK_API_URL: &str = "https://formulae.brew.sh/api/cask/dsx.json";
